 ...
 */
class MakeMgsql extends MakeDbTable
{
    ...
    private $_dataTypes = array(
        ...
        'money'            => 'float',
        /* Character Types */
        'character varyin' => 'string', 'varchar'          => 'string', 'character'        => 'string',
    ...
    public function parseForeignKeys()
    {
        ...
        $keys = array();
        foreach ($res as $row) {
            $keys [] = array('key_name'                => $row ['constraint_name'],
                'column_name'             => $row ['column_name'],
                'foreign_tbl_name'        => $row ['foreign_table_name'], 'foreign_tbl_column_name' => $row ['foreign_column_name']);
