...
namespace <?=$this->_namespace?>\Model\Mapper;
/**
...
* @see <?=$this->_namespace?>\Model\DbTable\<?=$this->_className."\n"?>
*/
require_once dirname(__FILE__) . '/../DbTable/<?=$this->_className?>.php';
<?php endif ?>

/**
* Data Mapper implementation for <?=$this->_namespace?>\Model\<?=$this->_className."\n"?>
*
* @package <?=$this->_namespace?>\Model
* @subpackage Mapper
* @author <?=$this->_author . "\n"?>
*/
class <?=$this->_className?> extends MapperAbstract
{
...
*
* @param <?=$this->_namespace?>\Model\<?=$this->_className?> $model
* @return array
*/
public function toArray($model)
{
if (! $model instanceof \<?=$this->_namespace?>\Model\<?=$this->_className?>) {
<?php if (! empty($this->_loggerName)):?>
if (is_object($model)) {
$message = get_class($model) . " is not a \<?=$this->_namespace?>\Model\<?=$this->_className?> object in toArray for " . get_class($this);
} else {
$message = "$model is not a \<?=$this->_namespace?>\Model\<?=$this->_className?> object in toArray for " . get_class($this);
}
...
*
* @param <?=$this->_namespace?>\Model\<?=$this->_className?> $model The model to <?php if ($this->_softDeleteColumn != null): ?>mark as deleted
<?php else: ?>delete
<?php endif; ?>
...
* @see <?=$this->_namespace?>\Model\DbTable\TableAbstract::delete()
<?php endif; ?>
* @return int
*/
...
<?php if (! empty($this->_loggerName)):?>
if (is_object($model)) {
$message = get_class($model) . " is not a \<?=$this->_namespace?>\Model\<?=$this->_className?> object in delete for " . get_class($this);
} else {
$message = "$model is not a \<?=$this->_namespace?>\Model\<?=$this->_className?> object in delete for " . get_class($this);
}
...
* @param <?=$this->_namespace?>\Model\<?=$this->_className?>|null $model
* @return <?=$this->_namespace?>\Model\<?=$this->_className?>|null The object provided or null if not found
*/
...
* @param <?=$this->_namespace?>\Model\<?=$this->_className?>|null $entry The object to load the data into, or null to have one created
* @return <?=$this->_namespace?>\Model\<?=$this->_className?> The model with the data provided
*/
public function loadModel($data, $entry)
{
if ($entry === null) {
$entry = new \<?=$this->_namespace?>\Model\<?=$this->_className?>();
}
