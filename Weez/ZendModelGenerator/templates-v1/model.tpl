...
* @see <?=$this->_namespace?>\Model\Mapper\<?=$this->_className . "\n"?>
*/
...
* @author <?=$this->_author."\n"?>
*/
class <?=$this->_className?> extends ModelAbstract
{
...
*
* @return <?=$this->_namespace?>\Model\Mapper\<?=$this->_className . "\n"?>
*/
public function getMapper()
{
if ($this->_mapper === null) {
$this->setMapper(new \<?=$this->_namespace?>\Model\Mapper\<?=$this->_className?>());
}
...
*
* @see <?=$this->_namespace?>\Model\Mapper\<?=$this->_className?>::delete
