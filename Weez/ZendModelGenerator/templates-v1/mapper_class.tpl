...
{
/**
* $_dbTable - instance of <?=$this->_namespace?>\Model\DbTable\TableAbstract
*
* @var <?=$this->_namespace?>\Model\DbTable\TableAbstract
*/
protected $_dbTable;
...
* @param <?=$this->_namespace?>\Model\ModelAbstract $model
...
$table_class = '\<?=$this->_namespace?>\Model\DbTable\\' . $object_table_name;
$rule = $name;
$type = 'parent';
} elseif (array_key_exists($name, $dependents)) {
$property = $dependents[$name]['property'];
$object_table_name = $dependents[$name]['table_name'];
$ref_table_name = '\<?=$this->_namespace?>\Model\DbTable\\' . $object_table_name;
$rule = $name;
...
$obj = $row->$method('\<?=$this->_namespace?>\Model\DbTable\\' . $object_table_name, $rule);

if (! empty($obj)) {
$model_class = '\<?=$this->_namespace?>\Model\\' . $object_table_name;
...
*
* @see <?=$this->_namespace?>\Model\DbTable\TableAbstract::countAllRows()
...
*
* @see <?=$this->_namespace?>\Model\DbTable\TableAbstract::countByQuery()
...
*
* @param <?=$this->_namespace?>\Model\ModelAbstract $model The model to delete
...
{
$adapter = new \<?=$this->_namespace?>\Model\Paginator($select, $this);
...
* @return array All <?=$this->_namespace?>\Model\ModelAbstract meeting the criteria
*/
...
* @param <?=$this->_namespace?>\Model\ModelAbstract|null $model
* @return <?=$this->_namespace?>\Model\ModelAbstract|null The matching models found or null if not found
*/
...
*
* @param new <?=$this->_namespace?>\Model\ModelAbstract $model
* @return array
*/
...
* @param <?=$this->_namespace?>\Model\ModelAbstract|null $entry The object to load the data into, or null to have one created
*/
