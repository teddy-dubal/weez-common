...
*
* @var <?=$this->_namespace?>\Model\ModelAbstract
*/
protected $_mapper;
...
*
* @param array $data
* @return <?=$this->_namespace?>\Model\ModelAbstract
*/
...
*
* @see <?=$this->_namespace?>\Model\Mapper\MapperAbstract::toArray()
* @return object
*/
...
*
* @see <?=$this->_namespace?>\Model\DbTable\TableAbstract::getPrimaryKeyName()
...
*
* @param <?=$this->_namespace?>\Model\Mapper\MapperAbstract $mapper
* @return <?=$this->_namespace?>\Model\ModelAbstract
*/
...
*
* @see <?=$this->_namespace?>\Model\Mapper\MapperAbstract::save()
...
*
* @param <?=$this->_namespace?>\Model\ModelAbstract $model Object to be compared to
...
*/
/*    public function diff(<?=$this->_namespace?>\Model\ModelAbstract $model,
...
if (is_null($value)) {
continue;
} elseif ($value instanceof \<?=$this->_namespace?>\Model\ModelAbstract)  {
...
if ($val instanceof \<?=$this->_namespace?>\Model\ModelAbstract) {
...
$other_value = array();
} elseif ($other_value instanceof \<?=$this->_namespace?>\Model\ModelAbstract) {
