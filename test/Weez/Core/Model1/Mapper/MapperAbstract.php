...
{
/**
* $_dbTable - instance of Weez\Core\Model\Model\DbTable\TableAbstract
*
* @var Weez\Core\Model\Model\DbTable\TableAbstract
*/
protected $_dbTable;
...
*
* @param Weez\Core\Model\Model\DbTable\TableAbstract $dbTable
* @return Weez\Core\Model\Model\Mapper\MapperAbstract
*/
...
* @return \Zend\Db\RowGateway\AbstractRowGateway_Abstract|null
*/
...
* @param Weez\Core\Model\Model\ModelAbstract $model
...
$table_class = '\Weez\Core\Model\Model\DbTable\\' . $object_table_name;
$rule = $name;
$type = 'parent';
} elseif (array_key_exists($name, $dependents)) {
$property = $dependents[$name]['property'];
$object_table_name = $dependents[$name]['table_name'];
$ref_table_name = '\Weez\Core\Model\Model\DbTable\\' . $object_table_name;
$rule = $name;
...
$obj = $row->$method('\Weez\Core\Model\Model\DbTable\\' . $object_table_name, $rule);

if (! empty($obj)) {
$model_class = '\Weez\Core\Model\Model\\' . $object_table_name;
...
*
* @see Weez\Core\Model\Model\DbTable\TableAbstract::countAllRows()
...
*
* @see Weez\Core\Model\Model\DbTable\TableAbstract::countByQuery()
...
*
* @param Weez\Core\Model\Model\ModelAbstract $model The model to delete
...
{
$adapter = new \Weez\Core\Model\Model\Paginator($select, $this);
...
* @return array All Weez\Core\Model\Model\ModelAbstract meeting the criteria
*/
...
* @param Weez\Core\Model\Model\ModelAbstract|null $model
* @return Weez\Core\Model\Model\ModelAbstract|null The matching models found or null if not found
*/
...
* @param array options
* @return Weez\Core\Model\Model\DbTable\TableAbstract
*/
...
*
* @param new Weez\Core\Model\Model\ModelAbstract $model
* @return array
*/
...
* @param Weez\Core\Model\Model\ModelAbstract|null $entry The object to load the data into, or null to have one created
*/
