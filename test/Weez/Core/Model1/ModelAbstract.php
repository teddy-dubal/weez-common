...
*
* @var Weez\Core\Model\Model\ModelAbstract
*/
protected $_mapper;
...
*
* @param array $data
* @return Weez\Core\Model\Model\ModelAbstract
*/
...
return $result;
} elseif (preg_match('/^fetchList(\w+)/', $method, $matches)) {
return call_user_func_array(array($this->getMapper(), $matches[0]), $args);
}
...
*
* @see Weez\Core\Model\Model\Mapper\MapperAbstract::toArray()
* @return object
*/
...
*
* @see Weez\Core\Model\Model\DbTable\TableAbstract::getPrimaryKeyName()
...
*
* @param Weez\Core\Model\Model\Mapper\MapperAbstract $mapper
* @return Weez\Core\Model\Model\ModelAbstract
*/
...
*
* @see Weez\Core\Model\Model\Mapper\MapperAbstract::save()
...
*
* @param Weez\Core\Model\Model\ModelAbstract $model Object to be compared to
...
*/
/*    public function diff(Weez\Core\Model\Model\ModelAbstract $model,
...
if (is_null($value)) {
continue;
} elseif ($value instanceof \Weez\Core\Model\Model\ModelAbstract)  {
...
if ($val instanceof \Weez\Core\Model\Model\ModelAbstract) {
...
$other_value = array();
} elseif ($other_value instanceof \Weez\Core\Model\Model\ModelAbstract) {
